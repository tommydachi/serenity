export const projects = [
  ...
  },
  {
    ...
    description_full:
      "A university project for a frontend engineering course as the second of two assessments. We designed and created a smaller version of the popular game Kahoot! using React and Javascript in pairs.",
